...
class myApp(object): 
    def __init__(self, **kw): 
        ...
        self.create_status_bar() #codigo para apresentação dos fonts disponiveis no sistema 
    ...
    def create_status_bar(self): 
        self.status = tk.Label(self.root, text="Bem vindo ao visualizador de fonts do caderno de laboratório", bd=1, relief=tk.SUNKEN, anchor=tk.W) 
